...
(function ($, undefined) {
  ...
  $.widget("geo.geographics", {
    ...
    _create: function () {
      ...
      if (document.createElement('canvas').getContext) {
        this._$elem.append(toStaticHTML('<canvas ' + sizeAttr + ' style="-webkit-transform:translateZ(0);' + posCss + '"></canvas>'));
        ...
        this._$elem.append( toStaticHTML('<div ' + sizeAttr + ' style="' + posCss + sizeCss + '"></div>'));
        this._$canvas = this._$elem.children(':last');
      ...
      this._$elem.append(toStaticHTML('<div class="geo-labels-container" style="-webkit-transform:translateZ(0);' + posCss + sizeCss + '"></div>'));
    ...
    drawLabel: function( coordinates, label ) {
      this._$labelsContainer.append(toStaticHTML( '<div class="geo-label" style="-webkit-transform:translateZ(0);position:absolute; left:' + coordinates[ 0 ] + 'px; top:' + coordinates[ 1 ] + 'px;">' + label + '</div>'));
    },
...
(function ($, undefined) {
  ...
  $.widget("geo.geomap", {
    ...
    _createChildren: function () {
      ...
      this._$elem.prepend(toStaticHTML('<div class="geo-event-target geo-content-frame" style="position:absolute; left:' + this._contentBounds.x + 'px; top:' + this._contentBounds.y + 'px;' + contentSizeCss + 'overflow:hidden; -khtml-user-select:none; -moz-user-select:none; -webkit-user-select:none; user-select:none;" unselectable="on"></div>'));
      this._$eventTarget = this._$contentFrame = this._$elem.children(':first');

      this._$contentFrame.append(toStaticHTML('<div class="geo-services-container" style="' + contentPosCss + contentSizeCss + '"></div>'));
      this._$servicesContainer = this._$contentFrame.children(':last');

      this._$contentFrame.append(toStaticHTML('<div class="geo-shapes-container" style="' + contentPosCss + contentSizeCss + '"></div>'));
      this._$shapesContainer = this._$contentFrame.children(':last');

      this._$contentFrame.append(toStaticHTML('<ul style="position: absolute; bottom: 8px; left: 8px; list-style-type: none; max-width: 50%; padding: 0; margin: 0;"></ul>'));
      this._$attrList = this._$contentFrame.children( ":last" );

      this._$contentFrame.append(toStaticHTML('<div class="geo-draw-container" style="' + contentPosCss + contentSizeCss + '"></div>'));
      this._$drawContainer = this._$contentFrame.children(':last');

      this._$contentFrame.append(toStaticHTML('<div class="geo-measure-container" style="' + contentPosCss + contentSizeCss + '"><span class="geo-measure-label" style="' + contentPosCss + '; display: none;"></span></div>'));
    ...
    _createServices: function () {
      ...
      for ( i = 0; i < this._options[ "services" ].length; i++ ) {
        ...
        this._$servicesContainer.append(toStaticHTML( scHtml ));
        ...
        if ( service.attr ) {
          this._$attrList.append(toStaticHTML( '<li>' + service.attr + '</li>' ));
        }
      }
    ...
    _createServiceGraphics: function( ) { 
      ...
      this._$elem.append(toStaticHTML('<div class="geo-shapes-container" style="position:absolute; left:0; top:0; width:' + $contentFrame.css( "width" ) + '; height:' + $contentFrame.css( "height" ) + '; margin:0; padding:0;"></div>'));
    ...
    _refreshDrawing: function ( ) {
      ...
      if ( this._drawPixels.length > 0 ) {
        ...
        if ( label ) {
          this._$measureLabel.html( toStaticHTML( label ) );
    ...
    return {
      create: function (map, serviceContainer, service, index) {
        ...
        if ( !serviceState ) {
          ...
          serviceContainer.append(toStaticHTML(scHtml));
      ...
      refresh: function (map, service, force) {
        ...
        if ( serviceState && service && service.style.visibility === "visible" && !( serviceState.serviceContainer.is( ":hidden" ) ) ) {
          ...
          if (!scaleContainer.size()) {
            $serviceContainer.append(toStaticHTML("<div style='-webkit-transform:translateZ(0);position:absolute; left:" + serviceLeft % tileWidth + "px; top:" + serviceTop % tileHeight + "px; width:" + tileWidth + "px; height:" + tileHeight + "px; margin:0; padding:0;' data-pixel-size='" + pixelSize + "'></div>"));
              ...
              if ($img.size() === 0 || serviceState.reloadTiles) {
                ...
                if (serviceState.reloadTiles && $img.size() > 0) {
                  ...
                  */
                  ...
                  scaleContainer.append(toStaticHTML(imgMarkup));
    ...
    return {
      ...
      refresh: function (map, service) {
        ...
        if ( serviceState && service && service.style.visibility === "visible" && !( serviceState.serviceContainer.is( ":hidden" ) ) ) {
          ...
          if ( !scaleContainer.size() ) {
            serviceContainer.append(toStaticHTML('<div style="-webkit-transform:translateZ(0);position:absolute; left:0px; top: 0px; width:' + mapWidth + 'px; height:' + mapHeight + 'px; margin:0; padding:0;" data-pixel-size="' + pixelSize + '" data-origin="[' + map._toMap( [ 0, 0 ] ) + ']"></div>'));
          ...
          scaleContainer.append(toStaticHTML('<img style="-webkit-transform:translateZ(0);position:absolute; left:' + ( imagePos.left / scaleContainer.width( ) * 100 ) + '%; top:' + ( imagePos.top / scaleContainer.height( ) * 100 ) + '%; width:100%; height:100%; margin:0; padding:0; -khtml-user-select:none; -moz-user-select:none; -webkit-user-select:none; user-select:none; display:none;" unselectable="on" />'));
